...
/** An <option>. The same shape for selects, radios and checkbox groups. */
...
export function RadioGroupField({ controlId, label, value, onChange, options, error, hint, inline = true, disabled }: RadioGroupFieldProps) {
  return (
    <Form.Group className="mb-3">
