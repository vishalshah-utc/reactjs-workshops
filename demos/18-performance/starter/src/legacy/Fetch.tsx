...
/**
 * @deprecated Read, do not extend. This is the 2018 shape of "load data and render it": a RENDER PROP. The
 * component owns the request lifecycle and calls `render(state)` with whatever it has; the caller supplies the
 * markup as a function. `useFetch` (src/hooks/useFetch.ts) is the same lifecycle as a hook — see the Demo 17
 * guide, Lab 6. Kept in src/legacy/ because you will inherit code like this, and Demo 23 adds more of it.
 */
