  ...
  return (
    <ToastStateContext value={toasts}>
      <ToastDispatchContext value={dispatch}>
        {/* TODO(lab-2.4): `children` is a PROP — the element was created by main.tsx, in a render a toast does
            not cause — so React skips the whole app on every push. Prove it: wrap <ToastViewport /> below in
            `<RenderProfiler id="toasts">`, push a toast, and watch "toasts" commit while "grid" stays silent. */}
        {children}
        <ToastViewport />
