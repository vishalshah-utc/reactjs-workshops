...
/**
 * Uploads: a different host, NO timeout (a 10 s timeout kills a large file),
 * and NO default Content-Type — the browser must set multipart/form-data with
 * its generated boundary. Setting it yourself is the classic upload bug.
 */
