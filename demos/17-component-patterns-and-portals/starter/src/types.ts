...
export interface Product {
  ...
  returnPolicy?: string;
  images?: string[];
  // TODO(lab-1.3): add `reviews?: Review[]` (and a Review interface: rating, comment, date, reviewerName, reviewerEmail),
  // plus weight, dimensions { width, height, depth } and minimumOrderQuantity — the detail-only fields the tabs show
}
