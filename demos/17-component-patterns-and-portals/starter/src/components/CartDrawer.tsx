  ...
  return (
    ...
    >
      ...
      <Offcanvas.Body className="d-flex flex-column">
        {/* TODO(lab-5.2): wrap everything in this body in <WidgetBoundary name="cart" resetKeys={[lines.length]}> */}
        ...
        <div className="mt-auto border-top pt-3">
          ...
          {user ? (
            ...
            // TODO(lab-3.2): <LinkOrButton variant="link" to=… block> — the same three classes the header's Sign in link wears
