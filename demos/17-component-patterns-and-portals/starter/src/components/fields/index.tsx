...
// ------------------------------------------------------------------ select
// TODO(lab-3.4): move SelectField to ./SelectField.tsx, generic over the option value (T inferred from `options`,
// NoInfer on value/onChange), move Option to FieldShell.tsx, and re-export both from here
