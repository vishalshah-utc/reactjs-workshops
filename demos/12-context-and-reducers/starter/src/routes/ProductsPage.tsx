...
import type { RootOutletContext, rootLoader } from './RootLayout';
...
export function ProductsPage() {
  ...
  // TODO(lab-4.3): replace useOutletContext with useWishlist() — the provider owns the wishlist now
  ...
  return (
    <>
      ...
      {/* TODO(lab-3.3): delete these three Alerts — toast the ?flash message and the delete result from effects instead */}
      {flash && (
