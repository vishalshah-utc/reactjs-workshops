...
// TODO(lab-2.3): a light/dark toggle button next to the cart — useTheme() from the ThemeContext
// TODO(lab-4.3): drop the wishlistCount prop — read useWishlist().ids.length here (cartCount stays a prop until Demo 13)
