...
export function CartDrawer() {
  ...
  // TODO(lab-2.3): the "Sign in to check out" Link's className becomes button({ block: true }) from src/lib/variants.ts.
  return (
    <Offcanvas
      show={isOpen}
      onHide={close}
      ...
      <Offcanvas.Body className="d-flex flex-column">
        ...
        <div className="mt-auto border-top pt-3">
          ...
          {user ? (
            ...
            <Link to="/login?redirectTo=/products" className="btn btn-primary w-100" onClick={followLink}>
