    ...
    children: [
...

      {
        ...
        children: [
          ...
          {
            // Admin-only, like `team` — and the ONLY route in the app whose data
            // is owned by a store instead of a loader. Demo 24a's whole point.
            path: 'inventory',
            middleware: [requireRole('admin')],
            lazy: async () => {
              const { InventoryPage, inventoryLoader } = await import('./routes/account/InventoryPage');
