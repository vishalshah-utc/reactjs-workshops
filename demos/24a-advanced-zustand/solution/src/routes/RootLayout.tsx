...
import { resetUserScopedStores } from '../store/registry';
...
export function RootLayout() {
  ...
  function handleSignOut() {
    ...
    // ONE call, however many stores register. The inventory console holds the
    // previous admin's catalogue page, their selection and their recently
    // inspected list — none of which belongs to whoever signs in next.
    // The cart and the wishlist are NOT registered: they are this browser's.
