...
export function ProfilePage() {
  ...
  return (
    <>
      ...
      {/* A feature flag from config: on in development and staging, off in production. Behind a boundary of its own:
          an upload widget that throws must not take the profile card with it. */}
      {env.features.uploads && (
        <div className="mt-4">
          <WidgetBoundary name="uploader">
            <Uploader />
          </WidgetBoundary>
        </div>
      )}
