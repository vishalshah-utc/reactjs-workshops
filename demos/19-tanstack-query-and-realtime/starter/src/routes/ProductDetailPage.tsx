 ...
 */
// TODO(lab-2.2): make the loader fill the CACHE —
// `queryClient.ensureQueryData(productQuery(productId))` instead of the bare
// `getProduct` — and read it back in the component with
// `useQuery({ ...productQuery(productId), initialData: loaded })`. Drop
// `request.signal`: the query owns this request now, and a loader aborting it
// would leave a rejected entry behind for the next visitor.
            ...
            <Col md={7}>
              <Stack gap={3}>
                ...
                <div className="d-flex align-items-center gap-3 flex-wrap">
                  ...
                  {/* TODO(lab-6.2): the polled figure next to the static one from the loader. */}
