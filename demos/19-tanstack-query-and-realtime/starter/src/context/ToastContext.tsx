  ...
  return (
    <ToastStateContext value={toasts}>
      <ToastDispatchContext value={dispatch}>
        {/* `children` is a PROP: the element was created by main.tsx, in a render that a toast does not cause.
            React compares it to itself, finds the same object, and skips the whole app — including the grid's
