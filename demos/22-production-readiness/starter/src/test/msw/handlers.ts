...
import { ADMIN_USER, CATALOGUE, CATEGORIES, makeProduct, reviewsFor } from '../fixtures';
...
export const handlers = [
  ...
  // Demo 21 fetches the reviews through this same path with `?select=reviews`,
  // so the handler has to honour `select` here too — a mock that ignores it
  // would hand the app a whole product where the code expects two fields.
