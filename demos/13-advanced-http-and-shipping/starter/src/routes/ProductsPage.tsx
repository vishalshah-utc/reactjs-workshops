...
// ---------------------------------------------------------------------------
// TODO(lab-3.2): wrap listProducts in withRetry — a GET is safe to repeat; the action's POST is NOT
...
export function ProductsPage() {
  ...
  // TODO(lab-1.1): OPTIMISTIC delete — hide the product whose id is in fetcher.formData; it comes back by itself if the action fails
