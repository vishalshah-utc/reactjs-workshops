...
This is where the thirteen demos arrive: a routed, authenticated product
explorer with a layered API module, loaders and actions, protected routes and
roles, a wishlist and a persisted cart in Zustand stores, optimistic deletes, uploads behind a feature flag, retries where they're
...
Read it in the order it was built — `demos/01` through `demos/13` — or start
