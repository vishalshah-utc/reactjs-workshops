# Demo 13 — Advanced HTTP & Shipping
...
routes, roles — and, since Demo 12, a wishlist and a cart in Zustand stores,
...
```
https://stackblitz.com/fork/github/vishalshah-utc/reactjs-workshops/tree/main/demos/13-advanced-http-and-shipping/starter
```

> ⚠️ Click once, bookmark the `stackblitz.com/edit/…` URL.

Locally: `cd demos/13-advanced-http-and-shipping/starter && npm install && npm run dev`.
