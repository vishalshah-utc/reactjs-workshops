...
export function CartDrawer() {
  ...
  // TODO(lab-5.1): set keyboard / autoFocus / enforceFocus / restoreFocus explicitly; aria-labelledby the title; a live <span> for the quantity instead of a disabled button; stand restoreFocus down when a link is followed
  return (
