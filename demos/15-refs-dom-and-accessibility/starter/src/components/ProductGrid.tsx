...
interface ProductGridProps {
  // TODO(lab-3.3): `ref?: Ref<HTMLDivElement>` — a prop like any other in React 19; put it on the Row and the empty-state div, with scrollMarginTop for the sticky header
  products: Product[];
  density?: Density;
  wishlist?: number[];
...
export function ProductGrid({ products, density = 'comfortable', wishlist = [], onToggleSave, onAddToCart, onEdit, onDelete, busyId = null }: ProductGridProps) {
