...
interface ProductGridProps {
  ...
  busyId?: string | null;
  /** DEV ONLY: hand every card the slow-mode flag (Demo 18 Lab 1). */
  slow?: boolean;
}

export function ProductGrid({ ref, products, density = 'comfortable', wishlist = [], onToggleSave, onAddToCart, onEdit, onDelete, busyId = null, slow = false }: ProductGridProps) {
