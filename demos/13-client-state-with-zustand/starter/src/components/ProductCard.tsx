...
export function ProductCard({ product, density = 'comfortable', saved = false, onToggleSave, onEdit, onDelete, busy = false }: ProductCardProps) {
        ...
        {!isCompact && (
          <div className="mt-auto d-flex justify-content-between align-items-center gap-2 pt-2">
            ...
            <div className="d-flex gap-1">
              ...
              {/* TODO(lab-2.2): onAddToCart?: (product: Product) => void — this button has never done anything */}
