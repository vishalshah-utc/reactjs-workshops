...
// TODO(lab-1.3): replace useWishlist().ids.length with useWishlistStore(selectWishlistCount), and the cartCount prop with useCartStore(selectCount)
// TODO(lab-2.4): the cart button opens the drawer: onClick={useCartStore((s) => s.open)}
export function SiteHeader({ cartCount = 0, user = null, onSignOut }: SiteHeaderProps) {
